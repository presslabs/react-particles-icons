...
const ParticlesComment = (props) => {
  ...
  return (
    ...
    >
      <g>
<path d="M20.446 11.543h-14.228c-0.497 0-0.9 0.403-0.9 0.9s0.403 0.9 0.9 0.9h14.228c0.497 0 0.9-0.403 0.9-0.9s-0.403-0.9-0.9-0.9z"/>
<path d="M20.446 15.1h-14.228c-0.497 0-0.9 0.403-0.9 0.9s0.403 0.9 0.9 0.9h14.228c0.497 0 0.9-0.403 0.9-0.9s-0.403-0.9-0.9-0.9z"/>
<path d="M20.446 18.656h-14.228c-0.497 0-0.9 0.403-0.9 0.9s0.403 0.9 0.9 0.9h14.228c0.497 0 0.9-0.403 0.9-0.9s-0.403-0.9-0.9-0.9z"/>
...
export default ParticlesComment;
